...
Open a pull request to add your project to the [list](https://github.com/safely-project/anchor/blob/master/docs/src/getting-started/projects.md).

* [Serum](https://github.com/safely-project)
* [Synthetify](https://github.com/Synthetify)
* [SafeFarm](https://solfarm.io/)
